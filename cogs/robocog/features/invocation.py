...
class InvocationFeature(Feature):
    ...
    @Feature.Command(parent="robo", name="override", aliases=["execute", "exec", "override!", "execute!", "exec!"])
    async def rovo_override(
        self,
        ctx: ContextT,
        ...
        for override in overrides:
            if isinstance(override, discord.User):
                ...
                if ctx.guild:
                    ...
                    #  the command more compatible with chaining, e.g. `robo in .. robo su ..`
                    target_member = None
    ...
    @Feature.Command(parent="robo", name="repeat")
    async def rovo_repeat(self, ctx: ContextT, times: int, *, command_string: str):
        """
        ...
        You can use this in conjunction with `robo sudo` to bypass this.
        """
    ...
    @Feature.Command(parent="robo", name="debug", aliases=["dbg"])
    async def rovo_debug(self, ctx: ContextT, *, command_string: str):
        """
    ...
    @Feature.Command(parent="robo", name="source", aliases=["src"])
    async def rovo_source(self, ctx: ContextA, *, command_name: str):
        """
