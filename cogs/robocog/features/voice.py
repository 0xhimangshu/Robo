...
class VoiceFeature(Feature):
    ...
    @Feature.Command(parent="robo", name="voice", aliases=["vc"],
                     invoke_without_command=True, ignore_extra=False)
    async def robo_voice(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="robo_voice", name="join", aliases=["connect"])
    async def robo_vc_join(
        self,
        ctx: ContextA,
        *,
    ...
    @Feature.Command(parent="robo_voice", name="disconnect", aliases=["dc"])
    async def robo_vc_disconnect(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="robo_voice", name="stop")
    async def robo_vc_stop(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="robo_voice", name="pause")
    async def robo_vc_pause(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="robo_voice", name="resume")
    async def robo_vc_resume(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="robo_voice", name="volume")
    async def robo_vc_volume(self, ctx: ContextA, *, percentage: float):
        """
    ...
    @Feature.Command(parent="robo_voice", name="play", aliases=["play_local"])
    async def robo_vc_play(self, ctx: ContextA, *, uri: str):
        """
