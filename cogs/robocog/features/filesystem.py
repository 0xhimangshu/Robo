...
from ..paginators import PaginatorInterface, WrappedFilePaginator, use_file_check
...
class FilesystemFeature(Feature):
    ...
    @Feature.Command(parent="robo", name="cat")
    ...
    @Feature.Command(parent="robo", name="curl")
